...
export default function Scorebar(props) {
  return (
    <>
      <ScorebarContainer>
        <span style={{display: 'inline-block', float:'left', color:'black', verticalAlign:'center', marginTop:'0.1em', marginLeft: '0.3em', fontSize:'1.3em', whiteSpace: 'nowrap'}}>Score: {props.scr}</span>
